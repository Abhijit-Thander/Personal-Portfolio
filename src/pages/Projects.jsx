...
//       <d
//         iv
//         className="relative h-80 overflow-hidden rounded-sm border border-[#a1a1a1] shadow-lg"
//       >
//         <img
//           src={project.image}
//           alt={project.title}
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 border-t border-[#a1a1a1] ">
        ...
        <div className="flex flex-wrap gap-x-3 gap-y-1 pt-1 font-cinzel text-xs tracking-widest uppercase text-[#888787]">
          {project.tags.map((tag, i) => (
            <span key={tag} className="flex items-center gap-3">
              {i !== 0 && (
                <span className="h-1 w-1 rounded-full bg-[#9C7C4C]" />
